...
// string concatenation, creating new string each time, memory allocation
...
// list operator '@' copies first list
// returning 'remains' as string creates a lot of strings
