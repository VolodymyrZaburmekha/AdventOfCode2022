...
let getDecodeFunc screen =
    ...
    let bottom =
        Set.difference allCharsSet (Set [ top; topLeft; topRight; middle; bottomLeft; bottomRight ]) |> Seq.exactlyOne
    ...
    fun (str: string) ->
        ...
        | 5 -> // 2 or 3 or 5
            if
                strSet = Set[top; topRight; middle; bottomLeft; bottom]
            then
                2
            elif strSet = Set [ top; topRight; middle; bottomRight; bottom ] then
                3
            else
                5
        | 6 -> // 6 or 9 or 0
            if strSet = Set [ top; topLeft; middle; bottomLeft; bottomRight; bottom ] then 6
            elif strSet = Set [ top; topLeft; topRight; bottomLeft; bottomRight; bottom ] then 0
            else 9
        | 7 -> 8
